...
{
    internal class ErrorLevens
    {
        public static int Start(string A, string B)
        {
        ...
        public static string Sugerir(List<string> Busqueda, List<string> Palabras)
        {
            string resultado = "";
            ...
            for (int i = 0; i < Busqueda.Count; i++)
            {
                ...
                else
                {
                    ...
                    {
                        int L = Start(Palabras[j], Busqueda[i]);
                        if (L < Mdis)
                        {
                            Mdis = L;
                            p = j;
